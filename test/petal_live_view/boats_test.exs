defmodule PetalLiveView.BoatsTest do
  use PetalLiveView.DataCase
  ...
  describe "boats" do
    ...
    @valid_attrs %{image: "some image", models: "some models", price: "some price", type: "some type"}
    @update_attrs %{image: "some updated image", models: "some updated models", price: "some updated price", type: "some updated type"}
    @invalid_attrs %{image: nil, models: nil, price: nil, type: nil}
    ...
    test "create_boat/1 with valid data creates a boat" do
      ...
      assert boat.models == "some models"
    ...
    test "update_boat/2 with valid data updates the boat" do
      ...
      assert boat.models == "some updated models"
